<div style="margin-top:25px;" class="row">
    <div class="span12">
        {{Form::open_for_files( URL::base() .'/'.ADM_URI.'/osregistration/avatars/'.$avatar->id, 'PUT', array('class' => 'form-horizontal'))}}
        ...
        <div class="form_inputs">
            ...
            <div class="control-group {{ $errors->has('name') ? 'error' : '' }}">
                ...
                <div class="controls">
                    {{ Form::text('name', Input::old('name', $avatar->name)) }}
            ...
            <div class="control-group {{ $errors->has('slug') ? 'error' : '' }}">
                ...
                <div class="controls">
                    {{ Form::text('slug', Input::old('slug', $avatar->slug)) }}
                    <span class="required-icon"></span>
            ...
            <div class="control-group {{ $errors->has('status') ? 'error' : '' }}">
                ...
                <div class="controls">
                    {{ Form::select('status', array(0 => Lang::line('osregistration::lang.Disabled')->get(ADM_LANG), 1 => Lang::line('osregistration::lang.Enabled')->get(ADM_LANG)), $avatar->status) }}
             ...
             <div class="control-group {{ $errors->has('description') ? 'error' : '' }}">
                ...
                <div class="controls">
                    {{ Form::text('description', Input::old('description', $avatar->description)) }}
            ...
            <div class="control-group {{ $errors->has('clone') ? 'error' : '' }}">
                ...
                <div class="controls">
                    {{ Form::select('clone', $clone_from, $avatar->uuid) }}
        ...
        <div class="form-actions">
            ...
            <button type="submit" name="btnAction" value="save" class="btn btn-primary">
                <span>{{ __('osregistration::lang.Save')->get(ADM_LANG) }}</span>
            </button>
        </div>
        {{Form::close()}}
    </div>
